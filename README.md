...
## 🧠 Models (Ollama)
Models selected for dense architecture (non-MoE preference) optimized for the 32 GB VRAM envelope:

| Model | Quantization | VRAM | Notes |
|---|---|---|---|
| **Qwen3-32B** | Q6_K_L | ~27 GB | Primary reasoning model |
| **DeepSeek-R1-Distill-32B** | Q6_K | ~27 GB | Full chain-of-thought (CoT) |
...
### Resources & Credits
  ...
  * [Nev89/Nev89 Intelligence Hub](https://www.google.com/search?q=../docs/intelligence-hub.md)
